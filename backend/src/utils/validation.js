...
/**
 * 5. FLEXIBLE ARRAY VALIDATOR
 */
/**
 * 5. ADVANCED ARRAY VALIDATOR
 * Rules:
 * - Max 20 items in array.
 * - Each item must be between 2 and 70 characters.
 * - Minimum array length check illa (0 is okay).
 */
