...
const CourseCurriculum = ({ courseData, totalLessons, hours, minutes, seconds }) => {
    ...
    return (
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8">
            <h2 className="text-2xl font-black text-[#1E2EDE] mb-2 uppercase tracking-tight">
                Syllabus <span className="text-[#14C4E7]">Modules</span>
            </h2>
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex justify-between items-center gap-4">
                                    <h4
                                        className={`text-sm font-bold truncate ${lesson.isFreePreview ? "text-[#14C4E7]" : "text-slate-700"}`}
                                    >
                                ...
                                {lesson.isFreePreview ? (
                                    ...
                                    <p className="text-[10px] text-slate-300 font-bold mt-1 uppercase tracking-tight">
                                        Locked Content
                                    </p>
                                )}
                            </div>
