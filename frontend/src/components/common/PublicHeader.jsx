            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden lg:flex items-center gap-4">
                        <button className="text-sm font-bold text-[#1E2EDE] hover:text-[#14C4E7] transition-colors px-4 py-2">
                            Log In
                        </button>
                        <button className="bg-[#1E2EDE] text-[#FDFDFD] px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-[#14C4E7] hover:text-[#1E2EDE] transition-all shadow-md active:scale-95">
                            Get Started
                        </button>
                    </div>
            ...
            >
                <div className="px-4 py-6 space-y-4 shadow-xl">
                    ...
                    <div className="pt-4 flex flex-col gap-3">
                        <button className="w-full py-3 text-[#1E2EDE] font-bold border-2 border-[#1E2EDE] rounded-xl">
                            Log In
                        </button>
                        <button className="w-full py-3 bg-[#1E2EDE] text-[#FDFDFD] font-bold rounded-xl">
                            Get Started
                        </button>
                    </div>
                </div>
