        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/articles" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  Latest Articles
                </a>
              </li>
              <li>
                <a href="/faq" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  FAQ
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/art-design" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  Art & Design
                </a>
              </li>
              <li>
                <a href="/business" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  Business
                </a>
              </li>
              <li>
                <a href="/it-software" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  IT & Software
                </a>
              </li>
              <li>
                <a href="/languages" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  Languages
                </a>
              </li>
              <li>
                <a href="/programming" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  Programming
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              <div className="text-gray-400 text-sm">
                <span className="block">Address: 123 Main Street, Anytown, CA 12345</span>
              </div>
              <div className="text-gray-400 text-sm">
                <span className="block">Tel: +1(123) 456-7890</span>
              </div>
              <div className="text-gray-400 text-sm">
                <span className="block">Mail: byway.edu@webkul.in</span>
              </div>
            </div>
