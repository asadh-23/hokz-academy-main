        ...
        <tr className="hover:bg-gray-50 transition-colors">
            ...
            <td className="p-4 border-b border-gray-100">
                <div className="flex items-center gap-3">
                    ...
                    <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center bg-cyan-500 text-white font-semibold text-sm">
                        {tutor.profileImage ? (
                            <img
                                ...
                                alt={formatText(tutor.fullName, 16)}
                    ...
                    {/* Name + ID */}
                    <div>
                        <div className="font-medium text-gray-800">{formatText(tutor.fullName, 20) || "_"}</div>
                        <div className="text-xs text-gray-500">ID: {tutor._id?.slice(-6).toUpperCase()}</div>
                    </div>
                </div>
            </td>
