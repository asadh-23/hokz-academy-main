  ...
  const approaches = [
    {
      ...
      description: "We move beyond passive consumption. Our curriculum is built on hands-on projects and real-time problem solving.",
      icon: <Zap className="w-6 h-6 text-[#1E2EDE]" />,
      color: "bg-blue-50"
    },
    {
      title: "Mentor-First Ecosystem",
      description: "Every student is paired with industry practitioners, not just academics, ensuring practical knowledge transfer.",
      icon: <Users className="w-6 h-6 text-[#14C4E7]" />,
      color: "bg-cyan-50"
    },
    {
      title: "Adaptive Curriculum",
      description: "Our content evolves weekly based on industry shifts and technology trends to keep you ahead of the curve.",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1E2EDE]/5 border border-[#1E2EDE]/10">
                ...
                <span className="text-[#1E2EDE] text-xs font-black uppercase tracking-widest">The Hokz Standard</span>
              </div>
              ...
              <p className="text-xl text-slate-600 leading-relaxed max-w-xl">
                Hokz Academy was born from a simple realization: Traditional education is too slow for the digital age. We've built an elite ecosystem where the distance between learning and doing is zero.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="bg-[#1E2EDE] p-12 lg:p-20 rounded-[4rem] text-white space-y-8 relative overflow-hidden group">
              ...
              <p className="text-lg text-white/70 leading-relaxed">
                To democratize access to high-tier expertise by creating a platform that is as rigorous as a university and as fast as a startup. We believe education should be an investment, not an expense.
              </p>
              <div className="pt-4">
            ...
            <div className="space-y-12 pl-4 lg:pl-12">
              <div className="space-y-4">
                <h2 className="text-[#14C4E7] font-black uppercase tracking-[0.3em] text-sm">Strategic Vision</h2>
                <h3 className="text-3xl font-black text-[#1E2EDE]">Building a Global Meritocracy</h3>
                <p className="text-slate-500 leading-relaxed">
                  We envision a world where your location, background, or economic status doesn't limit your potential. Through Hokz Academy, your talent is the only currency that matters.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div>
                  <h4 className="text-4xl font-black text-[#1E2EDE] mb-2 tracking-tighter">100+</h4>
                  <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">Industry Partnerships</p>
                </div>
                <div>
                  <h4 className="text-4xl font-black text-[#1E2EDE] mb-2 tracking-tighter">12k</h4>
                  <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">Global Alumni</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {approaches.map((item, idx) => (
              <div key={idx} className="p-10 rounded-[2.5rem] bg-[#FDFDFD] border border-slate-50 hover:shadow-2xl hover:border-white transition-all duration-500 group">
            ...
            {faculty.map((tutor, idx) => (
              <div key={idx} className="group">
                <div className="relative overflow-hidden rounded-[2.5rem] aspect-[4/5] mb-6">
                  <img src={tutor.image} alt={tutor.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                  ...
                  <div className="absolute bottom-6 left-6 right-6 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all">
                    <button className="w-full py-3 bg-[#14C4E7] text-[#1E2EDE] font-black rounded-xl text-sm">View Portfolio</button>
                  </div>
                </div>
                <h4 className="text-xl font-black text-[#1E2EDE]">{tutor.name}</h4>
                <p className="text-[#14C4E7] text-xs font-bold uppercase tracking-widest mb-2">{tutor.role}</p>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-12">
          ...
          <h2 className="text-5xl lg:text-7xl font-black text-white leading-tight">
            Stop Dreaming. <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#14C4E7] to-[#E6D929]">Start Dominating.</span>
          </h2>
          <p className="text-white/60 text-xl max-w-2xl mx-auto leading-relaxed">
            The world doesn't wait for those who are ready; it rewards those who take the leap. Join the Hokz elite and rewrite your narrative today.
          </p>
          <div className="pt-8">
            <button className="px-16 py-6 bg-[#E6D929] hover:bg-[#14C4E7] text-[#1E2EDE] font-black rounded-[2rem] text-xl transition-all shadow-2xl shadow-black/20 transform hover:-translate-y-2 active:scale-95 group">
              Apply to the Academy
              <Rocket className="inline-block ml-3 group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" size={24} />
            </button>
          </div>
          <p className="text-white/30 text-xs font-bold uppercase tracking-[0.2em]">Limited Cohorts Available for Q2 2024</p>
        </div>
      </section>
    </div>
  );
