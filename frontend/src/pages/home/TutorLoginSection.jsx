...
import TutorLoginSectionImage from "../../assets/images/tutorLoginSection.avif"
                ...
                <div className="bg-[#1E2EDE] rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row items-stretch">
                    ...
                    <div className="flex-1 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
                        <div className="inline-flex items-center space-x-2 bg-white/10 w-fit px-4 py-1.5 rounded-full mb-8 backdrop-blur-sm border border-white/10">
                            ...
                            <span className="text-[#FDFDFD] text-xs font-bold tracking-widest uppercase">
                                Instructor Gateway
                            </span>
                        </div>
                        ...
                        <p className="mt-6 text-lg text-white/70 leading-relaxed max-w-lg">
                            Elevate your teaching career by joining a global network of specialized experts. We provide the
                            sophisticated tools you need to inspire and lead.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button
                                ...
                                className="px-10 py-4 bg-[#E6D929] hover:bg-[#d4c825] text-[#1E2EDE] font-black rounded-2xl transition-all shadow-lg shadow-[#E6D929]/20 flex items-center justify-center gap-2 group"
                            >
                                Join our Faculty
                                <svg
                            ...
                            <button
                                onClick={() => navigate("/tutor/register")}
                                className="px-10 py-4 bg-transparent hover:bg-white/5 text-[#FDFDFD] border-2 border-white/20 font-bold rounded-2xl transition-all flex items-center justify-center"
                            >
                                Faculty Portal
                            </button>
                        </div>
                    ...
                    <div className="lg:w-[40%] bg-[#14C4E7] relative min-h-[400px] flex items-center justify-center">
                        ...
                        <div
                            ...
                            style={{
                                backgroundImage: "radial-gradient(#1E2EDE 1px, transparent 1px)",
                        ...
                        <div className="relative z-10 p-12">
                                    ...
                                    <div className="absolute bottom-4 left-4 right-4 bg-[#1E2EDE]/90 backdrop-blur-md p-4 rounded-xl border border-white/10">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-[#14C4E7] text-[10px] font-medium uppercase tracking-widest">
                                                    Master of Sciences
                                                </p>
                                            </div>
                            ...
                            <div className="absolute -bottom-6 -right-2 bg-[#FDFDFD] p-5 rounded-2xl shadow-xl border border-[#14C4E7]/20 flex flex-col items-center">
                                ...
                                <span className="text-slate-500 text-[10px] font-bold uppercase whitespace-nowrap tracking-tighter">
                                    Retention Rate
                                </span>
                            </div>
                        </div>
