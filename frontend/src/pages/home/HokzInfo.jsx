...
export const HokzInfo = () => {
  const benefits = [
    {
      ...
      description: "Access a curated selection of high-tier courses designed by industry leaders to give you a competitive edge.",
      icon: (
    ...
    },
    {
      ...
      description: "Learn directly from world-class faculty and professionals who have navigated the paths you aim to follow.",
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Never stay stuck. Our round-the-clock support system ensures your questions are answered precisely when they arise.",
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section id="about-us" className="py-24 bg-[#FDFDFD] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
          ...
          <h3 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#1E2EDE] leading-tight">
            Why Choose <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E2EDE] to-[#14C4E7]">Hokz Academy?</span>
          </h3>
          <p className="text-slate-500 text-lg font-medium leading-relaxed">
            We don't just provide courses; we build careers. Our platform is a synergy of cutting-edge technology and human expertise.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-24">
          {benefits.map((benefit, idx) => (
            <div key={idx} className="group p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
              <div 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/10 backdrop-blur-md">
                ...
                <span className="text-white text-xs font-bold uppercase tracking-widest">Interactive Learning</span>
              </div>
                  ...
                  <div key={idx} className="flex items-start gap-4 p-4 rounded-2xl hover:bg-white/5 transition-colors group">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded ${feature.color} text-white`}>{feature.tag}</span>
                      </div>
            ...
            <div className="relative">
                ...
                <div className="p-6 h-[400px] flex items-center justify-center bg-slate-100/50">
                  <div className="text-center space-y-4">
                    <div className="w-24 h-24 bg-[#1E2EDE]/10 rounded-full flex items-center justify-center mx-auto relative">
                       <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=200" alt="Tutor" className="w-20 h-20 rounded-full object-cover" />
              ...
              {/* Floating Badge */}
              <div className="absolute -bottom-8 -left-8 bg-[#E6D929] p-6 rounded-3xl shadow-2xl animate-bounce" style={{ animationDuration: '6s' }}>
                <p className="text-[#1E2EDE] font-black text-2xl">99%</p>
                <p className="text-[#1E2EDE] text-[10px] font-black uppercase tracking-widest opacity-60">Satisfaction</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-32 text-center">
          <div className="relative inline-block">
             ...
             <h4 className="text-2xl sm:text-3xl font-bold text-[#1E2EDE] italic leading-relaxed max-w-4xl mx-auto relative z-10">
               "The path to excellence is paved with persistence, and the right guidance makes that path a highway to your dreams."
             </h4>
             <span className="text-8xl text-[#1E2EDE]/5 absolute -bottom-10 -right-10 font-black">"</span>
          </div>
          <div className="mt-12">
            <button className="px-12 py-5 bg-[#1E2EDE] hover:bg-[#14C4E7] text-white font-black rounded-2xl transition-all shadow-xl shadow-[#1E2EDE]/20 transform hover:-translate-y-1 active:scale-95">
