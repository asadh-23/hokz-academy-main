...
import { 
  ...
  Eye, ShoppingBag, Calendar, User, 
  IndianRupee, BookOpen, Landmark, TrendingUp 
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 md:p-8 font-sans">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">Overview of all transactions and enrollments.</p>
      </div>
                  ...
                  <tr key={order._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="font-mono text-xs font-medium text-gray-500 mb-1">
                        #{order.razorpayOrderId ? order.razorpayOrderId.split('_')[1] : order._id.slice(-6).toUpperCase()}
                      </div>
                       ...
                       <div className="flex flex-col gap-2">
                          {order.items?.slice(0, 2).map((item, idx) => (
                             <div key={idx} className="flex items-center gap-2">
                                <img 
                                  src={item.course?.thumbnailUrl || "https://via.placeholder.com/40"} 
                                  alt="" 
        ...
        {!loading && orders.length > 0 && (
          <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-gray-50">
             <p className="text-xs text-gray-500">
                Page <span className="font-bold text-gray-800">{pagination.currentPage}</span> of {pagination.totalPages}
             </p>
