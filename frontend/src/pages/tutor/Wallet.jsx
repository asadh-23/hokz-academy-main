...
import { 
  ...
  Download, Calendar, CreditCard, DollarSign, 
  Clock, CheckCircle, ShoppingBag, Layers 
} from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-indigo-600 to-violet-700 rounded-2xl p-6 text-white shadow-xl shadow-indigo-100 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-2 text-xs bg-white/20 w-fit px-3 py-1.5 rounded-full backdrop-blur-sm border border-white/10">
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition duration-300">
          <div className="flex justify-between items-start mb-4">
            ...
            <span className="text-[10px] font-medium text-emerald-700 bg-emerald-50 px-2 py-1 rounded border border-emerald-100" title="Your Net Income">
                  ...
                  <tr key={txn._id} className="hover:bg-gray-50 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                         ...
                         <div>
                            <p className="text-xs font-mono font-medium text-gray-600 mb-0.5" title={txn.transactionId}>
                    ...
                    <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                           {txn.student.image ? (
                               <img src={txn.student.image} alt="" className="w-8 h-8 rounded-full object-cover border border-gray-200" />
                           ) : (
                           ...
                           <div className="max-w-[150px]">
                              <p className="text-sm font-medium text-gray-900 truncate">{txn.student.name}</p>
                        ...
                        <div className="flex flex-col gap-2">
                           {txn.items?.map((item, idx) => (
                              <div key={idx} className="flex items-center gap-3">
                                 ...
                                 <span className="text-xs font-medium text-gray-700 truncate max-w-[200px]" title={item.title}>
                                    {item.title}
                                 </span>
                              </div>
                           ))}
