            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-[2rem] shadow-xl shadow-blue-900/5 border border-white p-8">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6 p-6 bg-white rounded-3xl shadow-sm border border-gray-100">
                            {/* Avatar Section */}
                            <div className="relative shrink-0">
                                <div className="w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden border-4 border-white shadow-lg ring-4 ring-[#14C4E7]/20">
                                    {/* 1. Image Check: Image undenkil athu kaanikkum */}
                                    {student?.image ? (
                                        <img
                                            src={student.image}
                                        ...
                                        /* 2. Fallback: Image illengil Name initial with Blue Gradient */
                                        <div className="w-full h-full bg-gradient-to-br from-[#1E2EDE] to-[#14C4E7] flex items-center justify-center text-white text-3xl md:text-4xl font-black">
                            ...
                            <div className="flex-1 text-center sm:text-left">
                                <h4 className="font-black text-[#1E2EDE] text-xl md:text-2xl truncate">
                                    {student?.name || "No Name Provided"}
                                </h4>

                                <div className="flex flex-col sm:flex-row flex-wrap justify-center sm:justify-start gap-3 mt-4">
                                    <div className="flex items-center gap-2 text-sm font-semibold text-gray-600 bg-gray-50 px-4 py-2 rounded-xl border border-gray-100 shadow-sm">
                ...
                <div className="space-y-8">
                                            ...
                                            {financials.couponDetails?.list && financials.couponDetails.list.length > 1 ? (
                                                <div className="space-y-2 bg-[#E6D929]/10 p-3 rounded-xl border border-[#E6D929]/30">
                                                    ...
                                                    {financials.couponDetails.list.map((coupon, idx) => (
                                                        <div
                                                            key={idx}
                                                            className="flex justify-between text-[#1E2EDE] text-xs font-bold"
                                                        >
                                                            <span className="flex items-center gap-1.5">
                                                                <Tag size={12} className="text-[#14C4E7]" /> {coupon.code}
                                                            </span>
                                                ...
                                                <div className="flex justify-between text-[#14C4E7] font-black bg-[#14C4E7]/5 p-3 rounded-xl border border-[#14C4E7]/10">
                                                    <span className="flex items-center gap-2 uppercase tracking-tighter">
                                                        <Tag size={14} /> {financials.couponDetails?.code}
                                                    </span>
                    ...
                    {/* 4. VISUAL TIMELINE */}
                    <div className="bg-white rounded-[2rem] shadow-xl shadow-blue-900/5 border border-white p-8">
                        <h3 className="font-black text-[#1E2EDE] mb-8 text-[11px] uppercase tracking-[0.2em] border-b border-gray-50 pb-4">
                            Order Tracking
                        </h3>
                        <div className="relative ml-2 space-y-10">
                            ...
                            <div className="relative pl-8 group">
                                ...
                                <h4 className="text-sm font-black text-[#1E2EDE] uppercase tracking-tight">
                                    Payment Verified
                                </h4>
                                <p className="text-xs text-gray-500 font-bold mt-1 uppercase tracking-tighter">
                                    Via {orderInfo.paymentMethod}
                                </p>
